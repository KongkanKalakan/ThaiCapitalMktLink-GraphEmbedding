...
def evaluate(embeds, idx_train, idx_val, idx_test, labels, isTest=True):
    ...
    for _ in range(50):
        ...
        for iter_ in range(100):
            ...
            test_accu = accuracy_score(test_lbls.cpu(), preds.cpu())
    ...
    return accs, macro_f1s, micro_f1s, k1, st
...
def run_similarity_search(test_embs, test_lbls):
    ...
    #st = ','.join(st)
    print("\t[Similarity] [5,10,20,50,100] : [{}]".format(','.join(st)))
    return st
